...
describe('Service Tests', () => {
  describe('HeaderConfiguration Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a HeaderConfiguration', async () => {
      ...
      it('should update a HeaderConfiguration', async () => {
        const returnedFromService = Object.assign(
          {
            logo: 'BBBBBB',
            width: 1,
      ...
      it('should return a list of HeaderConfiguration', async () => {
        const returnedFromService = Object.assign(
          {
            logo: 'BBBBBB',
            width: 1,
      ...
      it('should delete a HeaderConfiguration', async () => {
