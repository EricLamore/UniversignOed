...
describe('Service Tests', () => {
  describe('GroupPermission Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a GroupPermission', async () => {
      ...
      it('should update a GroupPermission', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of GroupPermission', async () => {
        const returnedFromService = Object.assign(
          {
            moveOperatorsToUniversignOrganization: true,
            allowCustomization: true,
      ...
      it('should delete a GroupPermission', async () => {
