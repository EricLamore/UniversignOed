...
import { CheckResultComponent } from 'app/entities/check-result/check-result.component';
...
describe('Component Tests', () => {
  describe('CheckResult Management Component', () => {
    let comp: CheckResultComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CheckResultComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.checkResults && comp.checkResults[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
