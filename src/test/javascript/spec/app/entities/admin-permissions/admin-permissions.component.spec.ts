...
import { AdminPermissionsComponent } from 'app/entities/admin-permissions/admin-permissions.component';
...
describe('Component Tests', () => {
  describe('AdminPermissions Management Component', () => {
    let comp: AdminPermissionsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AdminPermissionsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.adminPermissions && comp.adminPermissions[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
