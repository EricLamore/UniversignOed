...
describe('Service Tests', () => {
  describe('MapProperties Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a MapProperties', async () => {
      ...
      it('should update a MapProperties', async () => {
        const returnedFromService = Object.assign(
          {
            dummy: 'BBBBBB'
          },
      ...
      it('should return a list of MapProperties', async () => {
        const returnedFromService = Object.assign(
          {
            dummy: 'BBBBBB'
          },
      ...
      it('should delete a MapProperties', async () => {
