...
import com.universign.universigncs.oed.repository.GroupRepository;
...
public class GroupResourceIT {
    ...
    public void createGroup() throws Exception {
        ...
        assertThat(testGroup.getCreatedAt()).isEqualTo(DEFAULT_CREATED_AT);
        assertThat(testGroup.getLastUpdatedAt()).isEqualTo(DEFAULT_LAST_UPDATED_AT);
    }
    ...
    public void updateGroup() throws Exception {
        ...
        assertThat(testGroup.getCreatedAt()).isEqualTo(UPDATED_CREATED_AT);
        assertThat(testGroup.getLastUpdatedAt()).isEqualTo(UPDATED_LAST_UPDATED_AT);
    }
