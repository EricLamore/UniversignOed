...
/**
 * REST controller for managing {@link com.universign.universigncs.oed.domain.Link}.
 */
@RestController
@RequestMapping("/api")
public class LinkResource {
    ...
    public ResponseEntity<Link> updateLink(@RequestBody Link link) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, link.getId()))
            .body(result);
    }
