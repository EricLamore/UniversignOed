...
/**
 * REST controller for managing {@link com.universign.universigncs.oed.domain.Column}.
 */
@RestController
@RequestMapping("/api")
public class ColumnResource {
    ...
    /**
     * {@code PUT  /columns} : Updates an existing column.
     *
    ...
    public ResponseEntity<Column> updateColumn(@RequestBody Column column) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, column.getId()))
            .body(result);
    }
