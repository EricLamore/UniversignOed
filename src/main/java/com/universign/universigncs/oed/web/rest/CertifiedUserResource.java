...
import com.universign.universigncs.oed.repository.CertifiedUserRepository;
...
/**
 * REST controller for managing {@link com.universign.universigncs.oed.domain.CertifiedUser}.
 */
@RestController
@RequestMapping("/api")
public class CertifiedUserResource {
    ...
    public ResponseEntity<CertifiedUser> updateCertifiedUser(@RequestBody CertifiedUser certifiedUser) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, certifiedUser.getId().toString()))
            .body(result);
    }
