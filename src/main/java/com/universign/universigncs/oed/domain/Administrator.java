...
public class Administrator implements Serializable {
    ...
    private AdminPreferences dashboardPreferences;

    @DBRef
    @Field("oedPreferences")
    private AdminPreferences oedPreferences;
    ...
    public Administrator permissions(AdminPermissions adminPermissions) {
    ...
    public AdminPreferences getDashboardPreferences() {
        return dashboardPreferences;
    }

    public Administrator dashboardPreferences(AdminPreferences adminPreferences) {
        this.dashboardPreferences = adminPreferences;
        return this;
    }

    public void setDashboardPreferences(AdminPreferences adminPreferences) {
        this.dashboardPreferences = adminPreferences;
    }

    public AdminPreferences getOedPreferences() {
        return oedPreferences;
    }

    public Administrator oedPreferences(AdminPreferences adminPreferences) {
        this.oedPreferences = adminPreferences;
        return this;
    }

    public void setOedPreferences(AdminPreferences adminPreferences) {
        this.oedPreferences = adminPreferences;
    }
