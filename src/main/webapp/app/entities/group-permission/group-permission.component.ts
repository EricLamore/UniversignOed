...
export class GroupPermissionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.groupPermissionService
      ...
      .subscribe(
        (res: HttpResponse<IGroupPermission[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IGroupPermission): string {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInGroupPermissions(): void {
    this.eventSubscriber = this.eventManager.subscribe('groupPermissionListModification', () => this.loadPage());
  }

  delete(groupPermission: IGroupPermission): void {
  ...
  protected onSuccess(data: IGroupPermission[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
