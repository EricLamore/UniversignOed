...
export class CertifiedUserComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.certifiedUserService
      ...
      .subscribe(
        (res: HttpResponse<ICertifiedUser[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: ICertifiedUser): string {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInCertifiedUsers(): void {
    this.eventSubscriber = this.eventManager.subscribe('certifiedUserListModification', () => this.loadPage());
  }

  delete(certifiedUser: ICertifiedUser): void {
  ...
  protected onSuccess(data: ICertifiedUser[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
