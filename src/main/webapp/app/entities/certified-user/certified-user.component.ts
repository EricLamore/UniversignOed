...
export class CertifiedUserComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.certifiedUserService
      ...
      .subscribe(
        (res: HttpResponse<ICertifiedUser[]>) => this.paginateCertifiedUsers(res.body, res.headers),
  ...
  registerChangeInCertifiedUsers() {
    this.eventSubscriber = this.eventManager.subscribe('certifiedUserListModification', response => this.loadAll());
  }
