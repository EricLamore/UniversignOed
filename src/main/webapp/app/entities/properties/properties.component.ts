...
export class PropertiesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.propertiesService
      ...
      .subscribe(
        (res: HttpResponse<IProperties[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IProperties): string {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInProperties(): void {
    this.eventSubscriber = this.eventManager.subscribe('propertiesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProperties[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
