...
export class GroupConfigurationComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.groupConfigurationService
      ...
      .subscribe(
        (res: HttpResponse<IGroupConfiguration[]>) => this.paginateGroupConfigurations(res.body, res.headers),
  ...
  registerChangeInGroupConfigurations() {
    this.eventSubscriber = this.eventManager.subscribe('groupConfigurationListModification', response => this.loadAll());
  }
