...
export class HeaderConfigurationComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.headerConfigurationService
      ...
      .subscribe(
        (res: HttpResponse<IHeaderConfiguration[]>) => this.paginateHeaderConfigurations(res.body, res.headers),
  ...
  registerChangeInHeaderConfigurations() {
    this.eventSubscriber = this.eventManager.subscribe('headerConfigurationListModification', response => this.loadAll());
  }
