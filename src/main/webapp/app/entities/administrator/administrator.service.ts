...
export class AdministratorService {
  ...
  protected convertDateFromClient(administrator: IAdministrator): IAdministrator {
    const copy: IAdministrator = Object.assign({}, administrator, {
      ...
      resetDate: administrator.resetDate && administrator.resetDate.isValid() ? administrator.resetDate.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((administrator: IAdministrator) => {
        ...
        administrator.resetDate = administrator.resetDate ? moment(administrator.resetDate) : undefined;
      });
    }
    return res;
  }
