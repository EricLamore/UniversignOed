...
export class ErrorRequestComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.errorRequestService
      ...
      .subscribe(
        (res: HttpResponse<IErrorRequest[]>) => this.paginateErrorRequests(res.body, res.headers),
  ...
  registerChangeInErrorRequests() {
    this.eventSubscriber = this.eventManager.subscribe('errorRequestListModification', response => this.loadAll());
  }
